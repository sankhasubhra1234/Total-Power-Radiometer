...
function createPlayButton(){var playButton=document.createElement('div');var arrowHtml='<div style="width:0;height:0;margin-left:4px;'+
...
'margin-right:5px;border-style:none;background-repeat:no-repeat;'+
'background-image:url(\''+ctrlIconsUrl+'\');cursor:pointer;"></div>';ctrlBox.innerHTML=innerHTML;ctrlPausePlay=ctrlBox.getElementsByClassName('gfyCtrlPause')[0];ctrlPausePlay.onclick=pauseClick;ctrlReverse=ctrlBox.getElementsByClassName('gfyCtrlReverse')[0];ctrlReverse.onclick=reverse;ctrlReverse.style.backgroundPosition='-46px 0';ctrlSlower=ctrlBox.getElementsByClassName('gfyCtrlSlower')[0];ctrlFaster=ctrlBox.getElementsByClassName('gfyCtrlFaster')[0];if(vid.paused){setCtrlsPaused();}else{setCtrlsPlaying();}
...
return{init:init,refresh:refresh,getRootElement:getRootElement,checkScroll:checkScroll,onPageUpdate:onPageUpdate};};